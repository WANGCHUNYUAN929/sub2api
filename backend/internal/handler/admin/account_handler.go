...
type TestAccountRequest struct {
	...
	RequestHeadersOverride map[string]string `json:"request_headers_override"`
}
...
func (h *AccountHandler) Test(c *gin.Context) {
	...
	if err := h.accountTestService.TestAccountConnection(c, accountID, req.ModelID, req.Prompt, req.Mode, req.RequestHeadersOverride); err != nil {

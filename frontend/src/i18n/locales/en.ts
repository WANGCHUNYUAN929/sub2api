export default {
  ...
  version: {
    ...
    officialLatestVersion: 'Official latest version',
    upToDate: "You're running the latest version.",
    updateAvailable: 'A new version is available!',
    officialUpdateAvailable: 'Official version has an update',
    ...
    officialUpdateSource: 'Official update notification: {repo}',
    actualUpdateSource: 'Update button downloads from: {repo}',
    customUpdateNotReady: 'Your update repository has no newer release yet. Merge upstream and publish your custom image/release before using the update button.',
    refresh: 'Refresh',

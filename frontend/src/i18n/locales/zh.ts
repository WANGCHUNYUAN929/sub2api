export default {
  ...
  version: {
    currentVersion: '当前版本',
    latestVersion: '最新版本',
    officialLatestVersion: '官方最新版本',
    upToDate: '已是最新版本',
    updateAvailable: '有新版本可用！',
    officialUpdateAvailable: '官方版本有更新',
    releaseNotes: '更新日志',
    ...
    officialUpdateSource: '官方更新通知：{repo}',
    actualUpdateSource: '更新按钮下载源：{repo}',
    customUpdateNotReady: '你的更新仓库还没有更新版本。先合并官方更新并发布自定义镜像/Release 后，再使用更新按钮。',
    refresh: '刷新',
    sourceMode: '源码构建',
